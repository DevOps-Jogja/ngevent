...
export default function FloatingThemeToggle() {
    ...
    return (
        ...
        >
            {isDark ? (
                <svg
                    className="w-6 h-6 text-yellow-500 transition-transform group-hover:rotate-180 duration-500"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                >
                    <path
                ...
                <svg
                    className="w-6 h-6 text-gray-800 transition-transform group-hover:rotate-[-30deg] duration-500"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                >
                    <path
