    ...
    return (
        <div className="bg-white dark:bg-dark-card rounded-2xl p-6 shadow-sm border border-gray-100 dark:border-gray-800 mb-8 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div>
                    <h2 className="text-lg font-bold text-gray-900 dark:text-white">Dashboard View</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Switch between managing events and attending them</p>
                </div>
