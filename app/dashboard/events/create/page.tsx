        ...
        <div className="min-h-screen bg-gray-50 dark:bg-dark-primary animate-fade-in pb-20">
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] left-0 right-0 p-4 bg-white dark:bg-dark-card border-t border-gray-200 dark:border-gray-700 z-40 lg:static lg:bg-transparent lg:border-0 lg:p-0 lg:z-auto">
